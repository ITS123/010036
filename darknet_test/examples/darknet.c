...
extern void socket_detector(char *datacfg, char *cfgfile, char *weightfile, float thresh, float hier_thresh, char *outfile, int fullscreen, int port_num);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        socket_detector("cfg/coco.data", "cfg/yolov3.cfg", "yolov3.weights", thresh, .5, outfile, fullscreen, atoi(argv[2]));
